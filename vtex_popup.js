(function( $ ) {
    jQuery.fn.vtex_popup = function(_popup_options){
        ...
        var _popup_settings = jQuery.extend({
            ...
            opacity: 0.4,       // valor de opacidade do shade
            ...
            set:
            {
                ...
                events: function()
                {
                    ...
                    jQuery(document).bind("keyup", function(e) {
											...
											if (code === 27) _popup_plugin.close.popup();
                    });
                },
								centralize: function()
								{
									...
									left = ($(window).width()-elem.width())/2;
									elem.css({"top":top+$(document).scrollTop(),"left":left});
									
									//adicionar funcao que verifica tamanho da janela do usuário.
								}
            },
            show:
            {
